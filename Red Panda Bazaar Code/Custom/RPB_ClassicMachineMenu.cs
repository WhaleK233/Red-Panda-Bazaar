...
public class RPB_ClassicMachineMenu : IClickableMenu
{
    ...
    {
        var commonList = MenuHandler.CommonPrizeList;
        var couponList = MenuHandler.CouponPrizeList;
